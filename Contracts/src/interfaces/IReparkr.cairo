...
pub trait IReparkr<TContractState> {
    ...
    fn register_car(ref self: TContractState, plate: felt252, carModel: felt252, email: ByteArray);
    ...
    fn edit_car(ref self: TContractState, plate: felt252, new_car_model: felt252, new_email: ByteArray);
